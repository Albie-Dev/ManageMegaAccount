...
:run_no_build
wt -w 0 nt --title "MMA.API" cmd /k "cd /d %~dp0src\Microservices\MMA.API && dotnet run --no-build" ; nt --title "MMA.BlazorWasm" cmd /k "cd /d %~dp0src\Web.UI\MMA.BlazorWasm && dotnet run --no-build"
pause
goto menu

:run
wt -w 0 nt --title "MMA.API" cmd /k "cd /d %~dp0src\Microservices\MMA.API && dotnet run" ; nt --title "MMA.BlazorWasm" cmd /k "cd /d %~dp0src\Web.UI\MMA.BlazorWasm && dotnet run"
pause
goto menu

:watch_run
wt -w 0 nt --title "MMA.API" cmd /k "cd /d %~dp0src\Microservices\MMA.API && dotnet watch run" ; nt --title "MMA.BlazorWasm" cmd /k "cd /d %~dp0src\Web.UI\MMA.BlazorWasm && dotnet watch run"
pause
goto menu
